...
if (nd2>2) & (data2(3)>=1) & (data2(3)<=7), gam = data2(3);end
if (nd2>3) & (data2(4)>0), sa = data2(4);end
if (nd2>4) & (data2(5)>0), sb = data2(5);end
if (nd2>5) ,               A = data2(6);end
w = [];
if nargin<1|isempty(w1), wc = 33/Tp;
