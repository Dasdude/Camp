...
if multipleSeaStates
  [errorcode, Vcf,Hd,Hm0,Tp] = comnsize(Vcf,Hd,Hm0,Tp);
else
...
switch condon,
 case 0, % regular pdf is returned 
  f = wtweibpdf(h,A0,B0,C0).*wweibpdf(v,A1,B1);
