...
[errorcode, Scf,Hd,Tm02,Hm0] = comnsize(Scf,Hd,Tm02,Hm0);
if errorcode > 0
...
if any(k)
  ...
  B1(k) = (h(k)-h0)*slope2 + 0.16439526054778;
end
% Rayleigh parameter
B0 = 0.70079568211392;
...
switch condon,
 case 0, % regular pdf is returned 
  f = wraylpdf(h,B0).*wgampdf(s,A1,B1);
